...
<head>
    ...
    <script>
        ...
        const HINT = <?php echo _g('css_hint') == 'open' ? 'true' : 'false'; ?>;
        const LAZYLOAD = <?php echo _g('js_lazyload') == 'open' ? 'true' : 'false'; ?>;
        const CHAFFLE = <?php echo (_g('js_chaffle') == 'open' && in_array(_g('cdn'), array('jsdelivr', 'close'))) ? 'true' : 'false'; ?>;
    </script>
